...
class PositionController:
    ...
    def mpc_controller(self, current_state, target_state_arr, target_input_arr):
        ...
        # Set tracking reference for states and inputs
        # Set only output for reference
    ...
    def compute_action(self, measured_pos, measured_rpy, measured_vel, desired_pos_arr, desired_vel_arr, desired_rpy_arr, desired_thrust_arr):
        ...
        target_state_arr = np.hstack((desired_pos_arr, desired_vel_arr, desired_rpy_arr))
        ...
        input_desired, yaw_predicted = self.mpc_controller(current_state, target_state_arr, target_input_arr)
