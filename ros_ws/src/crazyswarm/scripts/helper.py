...
def rotation2euler(R): # use class scipy.spatial.transform.rotation
    """ convert rotation matrix to euler """

    r = Rotation.from_matrix(R) # use rotation matrix to represent a rotation operation

    euler = r.as_euler('XYZ', degrees=False) # transfer the rotation operation into euler angles
